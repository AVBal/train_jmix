package com.company.train.test_support;

import com.company.train.TrainApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "train_MainScreen", screenBasePackages = "com.company.train.screen")
@ContextConfiguration(classes = {TrainApplication.class, UiTestAssistConfiguration.class})
